...
const ProjectMultipleUrl = {
    ...
    create: async (data) => {
        const { project_id, Live_Link, VenderURL, Venderid_Userid, UserType, Status } = data;
        const [result] = await db.execute(
            `INSERT INTO project_mutiple_Url (project_id, Live_Link, VenderURL, Venderid_Userid, UserType, Status)
             VALUES (?, ?, ?, ?, ?, ?)`,
            [project_id, Live_Link || null, VenderURL || null, Venderid_Userid || null, UserType || null, Status || 'active']
        );
